...
<body>
    ...
    <div class="container" style="padding-top: 40px;">
        ...
        <div class="row">
            <h3 style="text-align: center;font-weight: 700;">Customer Login</h3>
            ...
            <div class="col-lg-6 mt-3" style="border: 1px solid #E9EBEC;padding: 50px;">
              ...
              <form action="verifyCustomer.php" method="POST">
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" id="customerEmail" name="emailCustomer" aria-describedby="emailHelp">
                  <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                </div>
                <div class="mb-3">
                  <label for="customerPassword" class="form-label">Password</label>
                  <input type="password" class="form-control" id="customerPassword" name="passwordCustomer">
                </div>
              ...
              <a href="customerRegistration.php" id="login_anchor"><i class="fas fa-user-plus"></i>  New here ? Open an Account. </a>
