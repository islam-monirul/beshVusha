          ...
          <div class="container" style="padding-top: 40px;">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6 mt-3" style="border: 1px solid #E9EBEC;padding: 50px;">
                    ...
                    <h6 style="color: grey; text-align: center;">Your complaints is submitted. Your feedback is really important to us.</h6>
                    <a href="shopOwnerDashboard.php" id="login_anchor"><i class="fas fa-arrow-circle-left"></i> Back to Dasboard.</a>
