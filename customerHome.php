...
?>
            ...
            <body>
                ...
                <section class="banner" style="background-color: #F0FFFF;">
                  <div class="container">
                      <div class="row">
                        <div class="col-sm-12">
                          <img src="sources/images/image2.png" alt="" class="img-fluid">
                          <h2>Welcome to BeshVusha</h2>
                ...
                <section style="padding: 0 0 100px 0;">
                  <div class="container" style="padding-top: 40px; text-align: center;">
                      ...
                      <h2 style="padding: 40px;color: red;"><span style="color: green;">EXPLORE</span> OUR PRODUCTS</h2>

                      <div class="row d-flex justify-content-center">
                      <?php
                        $prodFetch="SELECT * from products LIMIT 3";
                        try{
                  ...
                  <div style="text-align: center;padding-top: 50px;">
                    <button type="button" class="btn btn-outline-dark" onclick="forwardToProductpage()">EXPLORE ALL PRODUCTS</button>
                  </div>
                </section>
